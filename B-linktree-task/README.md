...
You are required to create a JSON API (it can be GraphQL or REST) that our front end clients will interact with.
...
- Consider extendability, these are 3 of hundreds of potential link types that we will be developing.
...
- Commit your work and submit Pull Requests as you would in a normal working environment.

---
# Submission
To submit this assessment, please fork the repo and submit a Pull Request when you are done.
